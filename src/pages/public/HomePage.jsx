...
const WHY_US = [
  {
    ...
    desc: 'Solutions engineered for African markets, challenges, and opportunities.',
    icon: (
  ...
  {
    title: 'Expert Team',
    desc: 'Seasoned engineers, scientists, and consultants across every tech domain.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Full lifecycle ownership — from discovery to deployment and ongoing support.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Dozens of projects delivered and hundreds of professionals trained across Africa.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { d: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', text: '+250 780 859 9921' },
